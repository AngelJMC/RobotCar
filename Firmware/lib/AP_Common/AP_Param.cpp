...
void AP_Param::show_all(void)
{
    ...
    for (ap=AP_Param::first(&token, &type);
        ...
        switch (type) {
        case AP_PARAM_INT8:
            Serial.println(s + String(": ") + (int)((AP_Int8 *)ap)->get());
            break;
        case AP_PARAM_INT16:
            Serial.println(s + String(": ") + (int)((AP_Int16 *)ap)->get());
            break;
        case AP_PARAM_INT32:
            Serial.println(s + String(": ") + (int)((AP_Int32 *)ap)->get());
            break;
        case AP_PARAM_FLOAT:
            Serial.println(s + String(": ") + (int)((AP_Float *)ap)->get());
            break;
        default:
            break;
        }
